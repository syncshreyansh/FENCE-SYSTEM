...
export default function TopAppBar({ onMenuClick, menuOpen = false }) {
  ...
  return (
    <header className="h-[72px] bg-surface flex items-center px-4 lg:px-6 shrink-0 justify-between sticky top-0 z-40 border-b border-surface-container-high shadow-[0px_4px_20px_rgba(0,0,0,0.08)] min-w-0 select-none">
      {/* Left: Menu (phone/tablet) + Zone Dropdown */}
      <div className="flex items-center gap-2 shrink-0 min-w-0">
        <button
          ...
          className="lg:hidden w-9 h-9 flex items-center justify-center rounded-lg text-on-surface-variant hover:text-on-surface hover:bg-surface-container-low transition-colors"
        >
        ...
        <div className="flex-shrink-0">
          <button className="flex items-center gap-2 bg-surface-container-lowest border border-surface-container-high px-3.5 py-2 rounded-lg shadow-sm hover:bg-surface-container-low transition-colors">
            ...
            <span className="font-bold text-on-surface text-xs font-mono uppercase tracking-wider whitespace-nowrap max-[399px]:hidden">Kanha Zone</span>
      ...
      {/* Center: Search */}
      <div className="hidden md:block flex-1 max-w-md mx-4 lg:mx-6 min-w-0">
      ...
      <div className="flex items-center gap-2 sm:gap-3 shrink-0">
        ...
        <button
          ...
          className="hidden lg:flex w-9 h-9 items-center justify-center rounded-lg text-on-surface-variant hover:text-on-surface hover:bg-surface-container-low transition-colors"
        >
